...
; ----------------------------------------------------------------------------
; <AUT2EXE INCLUDE-START: C:\Documents and Settings\Dave\My Documents\au3's\Rogue Summoning Bot.au3>
; ----------------------------------------------------------------------------
...
GUICreate("Burnersware Rogue Summoning Bot", 218, 100, 1, -1, "", $WS_EX_TOOLWINDOW + $WS_EX_TOPMOST)
...
$file = FileOpen(@ProgramFilesDir & "\Burnersware\7in1\Include\vars\summonvars.txt", 0)
$speed = FileReadLine($file, 1)
$avanumber = FileReadLine($file, 2)
FileClose($file)
...
; ----------------------------------------------------------------------------
; <AUT2EXE INCLUDE-END: C:\Documents and Settings\Dave\My Documents\au3's\Rogue Summoning Bot.au3>
; ----------------------------------------------------------------------------
