...
; ----------------------------------------------------------------------------
; <AUT2EXE INCLUDE-START: C:\Documents and Settings\Dave\My Documents\au3's\Rogue Fishing Bot.au3>
; ----------------------------------------------------------------------------
...
While 1
	...
	Do
		...
		If getfishs() > 0 And PixelGetColor(680 + $resolution2, 518 + $resolution) > $offwhite And PixelGetColor(688 + $resolution2, 517 + $resolution) > $offwhite And PixelGetColor(700 + $resolution2, 518 + $resolution) > $offwhite Then
			reelin()
...
; ----------------------------------------------------------------------------
; <AUT2EXE INCLUDE-END: C:\Documents and Settings\Dave\My Documents\au3's\Rogue Fishing Bot.au3>
; ----------------------------------------------------------------------------
